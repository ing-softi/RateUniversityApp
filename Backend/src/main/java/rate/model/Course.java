...
public class Course implements Comparable<Course>{
    ...
    public Course(Integer id, String name, Double averageRates, String professor, Double totalHours, String weekDay, String startTime, String endTime, Integer registeredStudents) {
        this.id = id;
        this.name = name;
